...
import "./RightMerkleTreeWithHistory.sol";
...
abstract contract StealthHub is RightMerkleTreeWithHistory, ReentrancyGuard {
    uint256 private m;
    ...
    */
    constructor(
        ...
        bytes32 _initRoot
    ) RightMerkleTreeWithHistory(_initRoot, _poseidon2Contract) {
