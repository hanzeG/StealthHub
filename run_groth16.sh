...
CIRCUIT_NAMES=(
    # "test/circuits/multi_merkle_10_20_10"
    # "test/circuits/multi_merkle_10_20_11"
    # "test/circuits/multi_merkle_10_20_12"
    # "test/circuits/multi_merkle_10_21_10"
    # "test/circuits/multi_merkle_10_22_10"
    # "test/circuits/multi_merkle_11_20_10"
    # "test/circuits/multi_merkle_12_20_10"

    "test/circuits/multi_merkle_4_4_4"
    "test/circuits/multi_merkle_5_5_5"
    "test/circuits/multi_merkle_6_6_6"
    "test/circuits/multi_merkle_7_7_7"
    "test/circuits/multi_merkle_8_8_8"
    "test/circuits/multi_merkle_9_9_9"
...
"test/circuits/multi_merkle_4_4_4")
                ...
                INPUT_NAME="multi_merkle_4_4_4"
                ;;

"test/circuits/multi_merkle_5_5_5")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_5_5_5"
                ;;

"test/circuits/multi_merkle_6_6_6")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_6_6_6"
                ;;

"test/circuits/multi_merkle_7_7_7")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_7_7_7"
                ;;

"test/circuits/multi_merkle_8_8_8")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_8_8_8"
                ;;

"test/circuits/multi_merkle_9_9_9")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_9_9_9"
                ;;

            "test/circuits/multi_merkle_10_20_10")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_10_20_10"
                ;;
            "test/circuits/multi_merkle_11_20_10")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_11_20_10"
                ;;
            "test/circuits/multi_merkle_12_20_10")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_12_20_10"
                ;;
            "test/circuits/multi_merkle_10_21_10")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_10_21_10"
                ;;
            "test/circuits/multi_merkle_10_22_10")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_10_22_10"
                ;;
            "test/circuits/multi_merkle_10_20_11")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_10_20_11"
                ;;
            "test/circuits/multi_merkle_10_20_12")
                PTAU_NAME="pot21_final"
                INPUT_NAME="multi_merkle_10_20_12"
                ;;
