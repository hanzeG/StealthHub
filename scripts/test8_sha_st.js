...
async function main() {
    ...
    for (let i = 0; i < insertionCount; i++) {
        const txResponse = await EthSha.shieldedTransfer(SAMPLE_COMMITMENT, zkProof, SAMPLE_DEPOSIT_VALUE);
    ...
    const outputFilePath = path.join(__dirname, "../data/sha_st_16_31_gas_used.json");
