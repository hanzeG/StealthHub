...
async function main() {
    ...
    for (let i = 0; i < insertionCount; i++) {
        const txResponse = await EthShm.deposit(SAMPLE_COMMITMENT, SAMPLE_DEPOSIT_VALUE, { value: SAMPLE_ETHER_VALUE });
    ...
    const outputFilePath = path.join(__dirname, "../data/shm_dep_16_31_gas_used.json");
