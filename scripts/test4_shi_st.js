...
async function main() {
    ...
    for (let i = 0; i < insertionCount; i++) {
        const txResponse = await EthShi.shieldedTransfer(SAMPLE_COMMITMENT, SAMPLE_COMMITMENT, zkProof, SAMPLE_DEPOSIT_VALUE);
    ...
    const outputFilePath = path.join(__dirname, "../data/shi_st_31_gas_used.json");
