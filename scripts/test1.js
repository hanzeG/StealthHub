...
const TREE_DEPTH = 12; // Depth of the Incremental Merkle Tree
const MMR_INSERTION_COUNT = 4096; // 2^12
const IMT_INSERTION_COUNT = 4096; // 2^12
...
async function main() {
    ...
    const outputFilePath = path.join(__dirname, "../data/12_gas_used.json");
